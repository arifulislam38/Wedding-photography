    ...
    return (
        <div className='pt-28 px-10'>
            <div className=' p-4 text-start flex flex-col gap-5'>
                <h1 className='text-4xl text-yellow-100 font-serif font-semibold'>Question: Difference between SQL and NoSQL</h1>
            ...
            <div className=' p-4 text-start flex flex-col gap-5'>
                <h1 className='text-4xl text-yellow-100 font-serif font-semibold'>Question: What is JWT, and how does it work?</h1>
                <p className='text-2xl text-gray-300'>
            ...
            <div className=' p-4 text-start flex flex-col gap-5'>
                <h1 className='text-4xl text-yellow-100 font-serif font-semibold'>Question: What is the difference between javascript and NodeJS?</h1>
                <p className='text-2xl text-gray-300'>
            ...
            <div className=' p-4 text-start flex flex-col gap-5'>
                <h1 className='text-4xl text-yellow-100 font-serif font-semibold'>Question: How does NodeJS handle multiple requests at the same time?</h1>
                <p className='text-2xl text-gray-300'>
