            ...
            <div className='grid lg:grid-cols-2 gap-8 p-8 items-center justify-center lg:w-[85%] mx-auto'>
                ...
                <div className=''>
                    <form onSubmit={handleSubmit} className='sm:w-full flex flex-col gap-5'>
                        <input className='lg:w-[80%] w-full mx-auto p-4 bg-transparent border rounded text-yellow-50' type="text" name='name' placeholder='Your Name' />

                        <input className='lg:w-[80%] w-full mx-auto p-4 bg-transparent border rounded text-yellow-50' type="text" name='image' placeholder='Image Link' />
                        ...
                        <button type="submit" className='lg:w-[80%] w-full mx-auto text-xl text-yellow-50 font-serif font-bold p-4 border rounded'>Create Account</button>

                        

                        <p className='text-xl font-serif text-gray-200 lg:w-[80%] w-full mx-auto'>Already have an account? <Link to='/login' className='text-yellow-50 underline'>Log in</Link></p>
                    </form>
                </div>
            </div>
        </div>
